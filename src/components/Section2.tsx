...
const Section2 = () => {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto mt-10 p-3 dark:bg-gray-900">
      <div className="container ">
        <div className="flex flex-col items-center justify-center  text-center">
          <div className=" flex justify-center flex-col items-center px-2 py-4 border-t  gap-4 w-full">
            <h2 className="text-lg font-bold oswald  tracking-tighter sm:text-2xl">Featured Blogs</h2>
            <p className="text-sm dm_sans text-gray-500">Check out our featured blog posts</p>
          </div>
        </div>
        {
          allBlogs.length > 0 ? (
                  ...
                  <Link href={post.slug} key={i}>
                    <Card className="hover:translate-y-2 transition-all duration-300 hover:border-dashed shadow-2xl hover:border-orange-500 h-[460px] rounded-xs py-2 px-2">
                      ...
                      <CardContent className="grid gap-3 px-2">
                        <div className="flex justify-start items-center gap-2 text-orange-500 dm_sans text-sm">
                          <span>Featured</span>
                        </div>
