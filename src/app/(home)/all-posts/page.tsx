            ...
            <div className='w-full max-w-7xl mx-auto p-4'>
                <div className="flex flex-col items-center justify-center  text-center">
                    <div className=" flex justify-start items-start p-2  w-full">
                        <h2 className="text-lg font-bold font-sans  tracking-tighter sm:text-xl">All Blog Posts</h2>
                    </div>
                </div>

                 <div className='flex justify-start w-full items-start flex-wrap lg:flex-nowrap'>
                    <section className=" mt-4 p-3 grid  grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                        {
                            currentPosts.map((post, i) => {
                                return (
                                    <Link href={post.slug} key={i}>
                                        <Card
                                            className="hover:translate-y-2 transition-all duration-300 shadow-2xl hover:border-orange-500 h-[430px] rounded-xs py-2 px-2"
                                        >
