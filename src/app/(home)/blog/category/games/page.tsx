...
import { BlogPost, BusinessData, GamesData, MusicData } from '@/lib/blogs'
...
const page = () => {
  ...
  const [games, setGames] = useState<BlogPost[]>([]);

  useEffect(() => {
    const gamesDataFun = async () => {
      let data = await GamesData;
      setGames(data);
    };
    gamesDataFun();
  }, []);
        ...
        <div className="container ">
          <div className="flex flex-col items-center justify-center  text-center">
            <div className="flex justify-center flex-col items-center p-2 gap-4 w-full">
              <h2 className="text-lg font-bold oswald tracking-tighter sm:text-2xl">Gaming Blogs</h2>
              <p className="text-sm dm_sans text-gray-500 text-center">
                Check out our favorite blog posts curated just for you!
              </p>
              ...
              <p className="text-sm dm_sans text-gray-500 text-center max-w-xl">
                Stay ahead in the gaming world with expert insights, tips, and the latest news. Whether you're a casual player or a pro, there's something here for everyone.
              </p>
            </div>
