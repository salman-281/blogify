...
import { BlogPost, HealthData } from '@/lib/blogs'
...
const page = () => {
  ...
  const [health, sethealth] = useState<BlogPost[]>([]);
  ...
  <h2 className="text-lg font-bold oswald tracking-tighter sm:text-2xl">Health & Wellness</h2>
  <p className="text-sm dm_sans text-gray-500 text-center">
    Your guide to living stronger, longer, and healthier.
  </p>
  ...
  <p className="text-sm dm_sans text-gray-500 text-center max-w-xl">
    Explore expert-backed tips on nutrition, fitness, mental health, and lifestyle habits to help you thrive physically and emotionally.
  </p>
</div>
        </div>
