        ...
        <div className="flex flex-col items-center justify-center  text-center">
          <div className="flex justify-center flex-col items-center p-4 w-full">
            ...
            <p className="text-sm text-gray-600 mt-2 max-w-xl">
              Discover our hand-picked featured posts curated specially for you. These articles highlight trending topics, expert insights, and must-read content that stands out from the rest.
            </p>
          </div>
