            ...
            <div className='w-full max-w-7xl mx-auto p-4'>
                <div className="flex flex-col items-center justify-center  text-center">
                    <div className="flex flex-col justify-center items-center p-4 w-full">
                        ...
                        <p className="text-sm text-gray-600 mt-2 max-w-xl">
                            Explore the most popular posts from the past week—these are the articles that sparked the most interest, engagement, and shares from our readers.
                        </p>
                    </div>
                ...
                <div className='flex justify-start w-full items-start flex-wrap lg:flex-nowrap'>
                    <section className=" mt-4 p-3 grid z-10 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                        {
                            currentPosts.filter((post) => post.popular === true).map((post, i) => {
                                return (
